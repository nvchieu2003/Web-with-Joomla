...
<div class="panel" data-fd-panel-news>
	<div class="">
		<div class="flex">
			<div class="flex-grow">
				<b class="panel-head-title"><?php echo JText::_('FD_BLOG');?></b>
				<div class="panel-info"><?php echo JText::_('FD_BLOG_DESC');?></div>
			</div>
		</div>
	</div>
	<div class="panel-body bg-white px-no pt-no m-no">
		...
		<div class="text-center mt-md">
			<a href="https://stackideas.com/blog" target="_blank" class="o-btn o-btn--primary block"><?php echo JText::_('FD_VIEW_BLOG');?></a>
		</div>
